...
function incrementarPorUno(array) {
   ...
   // Tu código:
   var masUno = array.map(array => {return array + 1});
   return masUno
}
...
function mesesDelAño(array) {
   ...
   // Tu código:
   var nuevoarray = array.filter(mes => mes == "Marzo" || mes == "Noviembre" || mes == "Enero")
   if (nuevoarray.includes("Marzo")&&nuevoarray.includes("Enero")&&nuevoarray.includes("Noviembre")){
      return nuevoarray}
...
function mayorACien(array) {
   ...
   // Tu código:
   var may = array.filter(num => num>100)
   return may 
}
